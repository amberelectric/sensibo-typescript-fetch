 ...
 * 
 * @export
 * @interface NewValueObject
 */
export interface NewValueObject {
    /**
     * the new value
     * @type {string}
     * @memberof NewValueObject
     */
    newValue: string;
}

export function NewValueObjectFromJSON(json: any): NewValueObject {
    return NewValueObjectFromJSONTyped(json, false);
}

export function NewValueObjectFromJSONTyped(json: any, ignoreDiscriminator: boolean): NewValueObject {
...
export function NewValueObjectToJSON(value?: NewValueObject | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
