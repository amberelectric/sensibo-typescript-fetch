...
export function AcStateFromJSON(json: any): AcState {
    return AcStateFromJSONTyped(json, false);
}

export function AcStateFromJSONTyped(json: any, ignoreDiscriminator: boolean): AcState {
    ...
    return {
        ...
        'swing': !exists(json, 'swing') ? undefined : json['swing'],
    };
}

export function AcStateToJSON(value?: AcState | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
