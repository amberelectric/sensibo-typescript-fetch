...
export interface ScheduleObject {
     ...
     * @memberof ScheduleObject
     */
    recurOnDAysOfWeek?: object;
}

export function ScheduleObjectFromJSON(json: any): ScheduleObject {
    return ScheduleObjectFromJSONTyped(json, false);
}

export function ScheduleObjectFromJSONTyped(json: any, ignoreDiscriminator: boolean): ScheduleObject {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'targetTimeLocal': json['targetTimeLocal'],
        'timezone': json['timezone'],
        'acState': AcStateFromJSON(json['acState']),
        'recurOnDAysOfWeek': !exists(json, 'recurOnDAysOfWeek') ? undefined : json['recurOnDAysOfWeek'],
    };
}

export function ScheduleObjectToJSON(value?: ScheduleObject | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'targetTimeLocal': value.targetTimeLocal,
        'timezone': value.timezone,
        'acState': AcStateToJSON(value.acState),
        'recurOnDAysOfWeek': value.recurOnDAysOfWeek,
    };
}
