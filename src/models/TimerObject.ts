...
export interface TimerObject {
    /**
     * fire the timer in X minutes
     * @type {number}
     * @memberof TimerObject
     */
...
export function TimerObjectFromJSON(json: any): TimerObject {
    return TimerObjectFromJSONTyped(json, false);
}

export function TimerObjectFromJSONTyped(json: any, ignoreDiscriminator: boolean): TimerObject {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'minutesFromNow': json['minutesFromNow'],
        'acState': AcStateFromJSON(json['acState']),
    };
}

export function TimerObjectToJSON(value?: TimerObject | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'minutesFromNow': value.minutesFromNow,
